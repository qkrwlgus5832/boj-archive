...
#include <stdlib.h>
#include <stdbool.h>
int original[100000000]; //원본 데이터
int tmp[100000000]; //mergesort함수에서 이용되는 배열
int natural[100000000]; //자연적으로 정렬된 배열을 인덱스대로 끊어주기 위한 배열
int tmp2[100000000]; //roate함수에서 이용되는 배열
int n;
int naturali = 1;
