...
int LCA(int node1, int node2) {
	...
	//		else {
	//			for (int i = 0; i < 17; i++) {
	//				if (parent[node2][i] != 0 && v2[node1].second >= v2[parent[node2][i]].second) {
	//					if (i >= 1)
	...
	//		else {
	//			for (int i = 0; i < 17; i++) {
	//				if (parent[node1][i] != 0 && v2[node2].second >= v2[parent[node1][i]].second) {
	//					if (i >= 1)
...
int main() {
	...
	for (int index = 2; index <= 100000; index++) {
		for (int j = 1; pow(2, j) <= v2[index].second + 1; j++) {
